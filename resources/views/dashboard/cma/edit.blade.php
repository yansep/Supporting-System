...
<div class="card card-default">
  ...
  <!-- /.card-header -->
    <div class="card-body">
          ...
          <div class="form-group">
            <form method="post" action="/dashboard/cma/{{ $recruitskus->id }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  @if ($recruitskus->status == "Approve" && $recruitskus->kolom1 != null)
                  <div class="mb-3">
      ...
      && $recruitskus->statuscma == null || $recruitskus->statuscma == "APPROVE")
       <div class="mb-3">
         <label for="statuscma" class="form-label">Prosses</label>
         <select class="form-control select2" style="width: 100%;" aria-label="Default select example" name="statuscma" required>
