                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @if ($recruitskus->status == "Approve" && $recruitskus->npk != null
                                            && $recruitskus->ketklaim == "Invoice" && $recruitskus->statusgahead == "Approve"
                                            ...
                                            @elseif($recruitskus->status == "Approve" && $recruitskus->statushrhead == "Approve"
                                                    && $recruitskus->statuspgs == "Approve" && $recruitskus->kolom1 == null)
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="ketklaim" class="form-label">Keterangan Invoice</label>
                                                                <input type="text" readonly class="form-control" id="ketklaim" name="ketklaim"
                                            ...
                                            @elseif($recruitskus->statuscma == "Approve")
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="ketklaim" class="form-label">Keterangan Invoice</label>
                                                            <input type="text" readonly class="form-control" id="ketklaim" name="ketklaim"
                                                                autofocus value="Progres Selesai">
                                                        </div>
                                                            <a href="/dashboard/ga/">
                                                            <button class="btn btn-success" type="button">Back</button></a>
                                                    </div>
                                            ...
                                            @elseif($recruitskus->statusgahead == "Reject")
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="ketklaim" class="form-label">Keterangan Invoice</label>
                                                            <input type="text" readonly class="form-control" id="ketklaim" name="ketklaim"
                                                                autofocus value="Progres Reject GA">
                                                        </div>
                                                            <a href="/dashboard/ga/">
                                                            <button class="btn btn-success" type="button">Back</button></a>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea type="text" readonly class="form-control @error('keterangan') is-invalid @enderror"
                                            ...
                                            @elseif($recruitskus->status == "Approve" && $recruitskus->ketklaim == "Invoice"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <option value="Reject" <?= $recruitskus->statusgahead == "Reject" ?
                                            ...
                                            @elseif($recruitskus->status == "Reject")
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="status" class="form-label">Prosses</label>
                                                            <input type="text" readonly class="form-control" id="status" name="status"
                                                            autofocus value="Reject Oleh HR Staff">
                                                        </div>
                                                        <a href="/dashboard/ga/">
                                                            <button class="btn btn-success" type="button">Back</button></a>
                                                    </div>
