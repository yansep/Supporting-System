        ...
        <table id="example1" class="table table-bordered table-striped" style = text-align:center
          ...
          <tbody>
            ...
            <tr>
                ...
                @else
                <td  style = text-align:center>@currency ($recruitsku->kolom1)</td>
                @endif

                @if($recruitsku->kolom2 == null)
                <td  style = text-align:center>Data Belum Diisi</td>
                @else
                <td  style = text-align:center>@currency ($recruitsku->kolom2)</td>
                @endif

                @if($recruitsku->total == null)
                <td style = text-align:center>Data Belum Diisi</td>
                @else
                <td  style = text-align:center>@currency($recruitsku->total)</td>
                @endif
